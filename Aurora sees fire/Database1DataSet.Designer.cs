...
namespace Aurora_sees_fire {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UtilizatoriDataTable : global::System.Data.TypedTableBase<UtilizatoriRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UtilizatoriRow AddUtilizatoriRow(string nume, string prenume, string username, int varsta, string parola) {
...
namespace Aurora_sees_fire.Database1DataSetTableAdapters {
    ...
    public partial class UtilizatoriTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Utilizatori] ([nume], [prenume], [username], [varsta], [parola" +
                "]) VALUES (@nume, @prenume, @username, @varsta, @parola);\r\nSELECT Id, nume, pren" +
                "ume, username, varsta, parola FROM Utilizatori WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Utilizatori] SET [nume] = @nume, [prenume] = @prenume, [username] = @username, [varsta] = @varsta, [parola] = @parola WHERE (([Id] = @Original_Id) AND ((@IsNull_nume = 1 AND [nume] IS NULL) OR ([nume] = @Original_nume)) AND ((@IsNull_prenume = 1 AND [prenume] IS NULL) OR ([prenume] = @Original_prenume)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_varsta = 1 AND [varsta] IS NULL) OR ([varsta] = @Original_varsta)) AND ((@IsNull_parola = 1 AND [parola] IS NULL) OR ([parola] = @Original_parola)));
SELECT Id, nume, prenume, username, varsta, parola FROM Utilizatori WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nume, prenume, username, varsta, parola FROM dbo.Utilizatori";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"INSERT INTO Utilizatori
                         (nume, prenume, username, varsta, parola, scor)
VALUES        (@nume,@prenume,@username,@varsta,@parola, 0);  
SELECT Id, nume, prenume, username, varsta, parola, scor FROM Utilizatori WHERE (Id = SCOPE_IDENTITY())";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@nume", global::System.Data.SqlDbType.NVarChar, 25, global::System.Data.ParameterDirection.Input, 0, 0, "nume", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@prenume", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "prenume", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@varsta", global::System.Data.SqlDbType.NVarChar, 3, global::System.Data.ParameterDirection.Input, 0, 0, "varsta", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@parola", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "parola", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        COUNT(*) AS Expr1\r\nFROM            Utilizatori\r\nWHERE        (usern" +
                "ame = @username) AND (parola = @parola) AND (admin = @admin)";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@admin", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "admin", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@parola", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "parola", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@parola", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "parola", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[5] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "SELECT        admin\r\nFROM            Utilizatori\r\nWHERE        (admin = 1)";
        ...
        public virtual int Delete(int Original_Id, string Original_nume, string Original_prenume, string Original_username, global::System.Nullable<int> Original_varsta, string Original_parola) {
        ...
        public virtual int Insert(string nume, string prenume, string username, global::System.Nullable<int> varsta, string parola) {
            if ((nume == null)) {
        ...
        public virtual int Update(string nume, string prenume, string username, global::System.Nullable<int> varsta, string parola, int Original_Id, string Original_nume, string Original_prenume, string Original_username, global::System.Nullable<int> Original_varsta, string Original_parola, int Id) {
            if ((nume == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nume, string prenume, string username, global::System.Nullable<int> varsta, string parola, int Original_Id, string Original_nume, string Original_prenume, string Original_username, global::System.Nullable<int> Original_varsta, string Original_parola) {
            return this.Update(nume, prenume, username, varsta, parola, Original_Id, Original_nume, Original_prenume, Original_username, Original_varsta, Original_parola, Original_Id);
        }
        ...
        public virtual int InsertQueryUtilizatori(string nume, string prenume, string username, string varsta, string parola) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> ScalarQueryAdmin(string username, string parola, global::System.Nullable<bool> admin) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> ScalarQueryGasireId(string username, string parola) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> ScalarQueryLogare(string username, string parola) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object ScalarQueryMeniu() {
